    ...
    return (
        <>
            ...
            <div className="container mx-auto -mt-40 lg:mt-32 px-6 h-[55rem]">
                <div className="bg-white rounded-lg h-[31rem] relative shadow-lg shadow-[#696969] lg:-mt-72 lg:h-[40rem] xl:h-[45rem] 2xl:h-[50rem] outline outline-1 ">
                    ...
                    <div className=" absolute translate-x-1/2 right-1/2 mt-24 2xl:mt-36 mx-auto">
                        <iframe
                            className="w-[34rem] h-[24rem] lg:w-[52rem] lg:h-[31rem] xl:w-[60rem] xl:h-[36rem] 2xl:w-[75rem] 2xl:h-[35rem]"
