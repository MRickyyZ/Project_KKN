                    ...
                    <div className="bg-white rounded-lg h-[33rem] relative shadow-lg lg:flex lg:flex-row lg:-mt-72 lg:h-[27rem] ">
                        ...
                        <div className="px-8 lg:*:ml-64 lg:w-1/2">
                            <p className="font-semibold text-lg -mt-36 lg:w-[20rem] lg:mt-4 xl:text-2xl xl:w-96">
                                Assalamualaikum WR. WB <br /> Salam Sejahtera
                                untuk kita semua
                            </p>
                            <p className="text-justify font-light mt-1 lg:w-[38rem] 2xl:text-lg 2xl:w-[60rem] 2xl:mt-3 xl:text-lg xl:w-[50rem] xl:mt-3">
                                ...
                                adipisicing elit. Consequuntur placeat magnam
                                laboriosam natus, voluptatem officiis ut odio
                                veniam, qui dolorem nam nihil! Ipsam at
                                veritatis reiciendis aliquid neque alias dolores
                                quae. Esse dolore ad quasi nisi, iure eligendi
                                nihil modi consectetur, explicabo cumque
                                ...
                                <p className="hidden lg:block">
                                    ...
                                    provident officiis ducimus aliquam
                                    consequuntur ullam nobis autem nam tempore,
                                    ut, quas ipsum laudantium! Repellat labore
                                    consequuntur eos unde animi dignissimos
                                    ullam deserunt doloremque soluta illum
                                    eveniet, earum vero reprehenderit blanditiis
                                    beatae adipisci placeat. Enim in reiciendis
                                    nulla laudantium.
                                </p>
                            </p>
                            <p
...
xl:text-lg xl:w-[50rem]"
                    ...
                    <div className="bg-white rounded-lg h-[14rem] shadow-lg relative lg:flex lg:h-72 mt-20 z-50 lg:z-0 lg:mt-16 lg:flex-col lg:w-[58rem] xl:w-[69rem]">
                        ...
                        <p className="mx-6 text-justify lg:w-96 lg:h-40 xl:ml-16">
                            ...
                            praesentium reiciendis reprehenderit eveniet,
                            delectus velit expedita, fugiat atque mollitia illo
                            repellendus! Consequuntur rem corporis reiciendis
                            architecto optio, possimus eligendi recusandae?
                        </p>
                    </div>
                    ...
                    <div className="flex flex-row xl:ml-10 2xl:ml-36 ">
                        ...
                        <div className="">
                            ...
                            <p className="w-[18rem] text-justify ml-6 mt-3 font-kulim text-md md:ml-12 md:w-[22rem] lg:w-[36rem] lg:text-xl lg:ml-14 xl:w-[41rem]  xl:ml-[6rem] xl:mt-10">
                                Website ini menyediakan layanan “Lapak Kost”
                                yaitu sebuah layanan yang memberikan sebuah
                                informasi yang valid dan terpecaya mengenai
                                kost-kostan sekitar RT 34 Kelurahan Karang
                                Joang. Tidak hanya kepada pengguna, website ini
                                juga berguna untuk masyarakat RT 34 khususnya
                                pengurus RT.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="w-[35rem] h-72 bg-white -mt-2 rounded-xl shadow-xl shadow-[#969696] flex md:w-[45rem] lg:w-[60rem] xl:h-80 xl:w-[77rem] 2xl:w-[92.5rem] gap-2 2xl:gap-10 ">
                        <div className="w-[14rem] h-44  z-50 bg-slate-300 mt-10 ml-4 rounded-xl relative outline outline-1 outline-black lg:w-[18.5rem] xl:w-[24rem] xl:h-56 xl:ml-6 2xl:w-[28rem] 2xl:ml-8 ">
                            <a
                                href="https://lppm.itk.ac.id/detail-berita/melalaui-program-pengabdian-masyarakat-pengolahan-limbah-kulit-udang-menjadi-kaldu-bubuk-dan-terasi"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <img
                                    src="https://lppm.itk.ac.id//public/uploads/posts/166987914318.jpg"
                                    className="rounded-xl w-auto h-32 md:h-auto lg:h-36 lg:w-full xl:h-full "
                                    alt="berita 1"
                                />
                                <div className="w-[10rem] h-16 rounded-br-xl rounded-bl-xl bottom-0 absolute  bg-[#333A73] md:w-[13.3rem] lg:w-[18.33rem]  xl:w-[23.87rem] 2xl:w-[27.19rem]">
                                    {" "}
                        ...
                        <div className="w-[14rem] h-44  z-50 bg-slate-300 mt-10 ml-4 rounded-xl relative outline outline-1 outline-black lg:w-[18.5rem] xl:w-[24rem] xl:h-56 2xl:w-[28rem] ">
                            <a
                                href="https://lppm.itk.ac.id/detail-berita/edukasi-pemanfaatan-teknologi-informasi-secara-sederhana-guna-meningkatkan-sdm-pada-kelurahan-karang-joang-rt-34"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <img
                                    src="https://lppm.itk.ac.id//public/uploads/posts/1655039999r.jpg"
                                    className="rounded-xl w-auto h-32 md:h-auto lg:h-36 lg:w-full xl:h-full "
                                    alt="berita 2"
                                />
                                <div className="w-[10rem] h-16 rounded-br-xl rounded-bl-xl bottom-0 absolute  bg-[#333A73] md:w-[13.3rem] lg:w-[18.3rem]  xl:w-[23.8rem] 2xl:w-[27.2rem]">
                                    <p className="text-sm  font-kulim font-semibold mx-auto text-center text-white xl:mt-2 xl:text-base">
                        ...
                        <div className="w-[14rem] h-44 z-50 bg-slate-300 mt-10 ml-4 mr-4 rounded-xl relative outline outline-1 outline-black lg:w-[18.5rem] xl:w-[24rem] xl:h-56 2xl:w-[27.8rem] 2xl:mr-8">
                            <a
                                href="https://lppm.itk.ac.id/detail-berita/melalui-program-pengabdian-mahasiswa-dan-dosen-itk-lakukan-pemberdayaan-lingkungan-pembuatan-hidroponik-dan-kompos"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <img
                                    src="https://lppm.itk.ac.id//public/uploads/posts/166925880225.jpg"
                                    className="rounded-xl w-auto h-32 md:h-auto lg:h-36 lg:w-full xl:h-full "
                                    alt="berita 3"
                                />
